...
sat_cons=('Cue:LW-Neut Cue:W-Neut Cue:LL-Neut Cue:L-Neut Cue:LW-Base FB:WHit-WMiss FB:LWHit-LWMiss FB:LWHit-NeutHit FB:LWHit-Base FB:LHit-LMiss FB:LLHit-LLMiss Fix:LW-Neut Fix:W-Neut Fix:LL-Neut Fix:L-Neut Fix:LW-Base Probe:All-Base Probe:Win-Base Probe:Loss-Base Probe:Neut-Base Probe:Win-Loss Probe:Win-Neut Probe:Loss-Neut RT')
